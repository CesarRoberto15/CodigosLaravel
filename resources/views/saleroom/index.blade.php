                ...
                @foreach($tables as $table)
                    ...
                    <div class="card col-5 col-sm-3 col-xl-1 m-1 p-0">
                        <div class="card-body p-0 border rounded">
                            <a class=" @if(count($table->tickets()->where('active',1)->get()) > 0) btn-danger @else btn-success @endif  p-0 m-0 btn btn-block" role="button" href="{{route('salesroom.table',['id' => $table->id]).'#tableDetails'}}">
